    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-saffron-200 shadow-sm">
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center" style={{ gap: '0.5rem' }}>
            <img
              ...
              style={{ mixBlendMode: 'multiply', filter: 'contrast(1.4)' }} />
        ...
        <nav className="md:hidden mt-4 pb-4 flex flex-col space-y-3">
            ...
            <button onClick={() => scrollToSection('founders')} className="hover:text-saffron-600 transition-colors !font-medium !text-left py-2 text-gray-700">Founders' Message
